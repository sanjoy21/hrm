    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>NOC Application Details</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                            <li class="breadcrumb-item active">NOC Application Details</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
     ...
     @elseif ($application->status == 'Rejected')
         style="background: url('{{ asset('images/rejected.png') }}') no-repeat center center;
                ...
                <img src="{{ asset('images/rk_logo.jpg') }}" style="padding-bottom: 30px;">
                                    ...
                                    <hr>
                                    <p align="center" style="padding-bottom: 10px; valign: bottom;">House# 286 (2nd Floor), Road: 19/C, New DOHS Mohakhali, Dhaka-1206<br>
    ...
    background-size: 300px auto; opacity: 0.95;" @endif>
                            ...
                            <div class="card-footer">
                                <div class="float-left">
                                    ...
                                    <form action="{{ route('noc_application_status', $application->id) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <button type="submit" name="status" value="Approved" class="btn btn-success"
                                            {{ $application->status == 'Approved' || $application->status == 'Rejected' ? 'disabled' : '' }}>
                                            Approve
                                        </button>
                                ...
                                <div class="float-right">
                                    ...
                                    <a href="{{ route('noc_application_all') }}" class="btn btn-default"><i
