                ...
                <div class="card-header">
                    <form>
                        ...
                        <div class="col-md-4">
                            ...
                            <a href="{{ route('project_all') }}" class="btn btn-secondary ml-2">Reset</a>
                        </div>
                    </form>
                </div>
                <!-- /.card-header -->
                    ...
                    <table id="example1" class="table table-striped projects">
                        ...
                        <tbody>
                            @foreach ($employees as $project)
                                @php
                                    // Get unread comments count for this project
                                ...
                                <tr class="{{ $unreadCommentsCount > 0 ? 'table-warning' : '' }}">
                                    ...
                                    <td>
                                        ...
                                        @if($unreadCommentsCount > 0)
                                            ...
                                            <small class="text-danger">
                                                <i class="fas fa-comment-dots"></i> {{ $unreadCommentsCount == 1 ? '1 new message' : $unreadCommentsCount . ' new messages' }}!
                                            </small>
                                        @endif
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-right py-0 align-middle">
                                        <div class="btn-group btn-group-sm">
                                            <a href="{{ route('project', $project->id) }}" class="btn btn-success">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{ route('project_edit', $project->id) }}" class="btn btn-info">
