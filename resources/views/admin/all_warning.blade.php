                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">All Warning</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        @foreach ($employees as $warning)
                                            <tr>
                                                <td>{{ $loop->iteration }}</td>
                                                <td>{{ $warning->title }}</td>
                                                <td>{{ Str::words(strip_tags($warning->message), 10, '...') }}</td>
                                                <td>
                                                    @foreach ($employee as $emp)
                                                        @if ($warning->to_employee == $emp->id)
                                                            {{ $emp->name }}
                                                        @endif
                                                    @endforeach
                                                </td>
                                                ...
                                                <td class="text-right py-0 align-middle">
                                                    <div class="btn-group btn-group-sm">
                                                        <a href="{{ route('warning', $warning->id) }}"
