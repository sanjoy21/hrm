...
<body class="hold-transition login-page">
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                <p class="login-box-msg">RK HRM | Admin Login</p>
                ...
                <hr>
                        <div class="row">
                            <div class="col-md-4">
                                <a href="{{ route('army.login') }}">BD Army</a></div>
                               <div class="col-md-4"> <a href="{{ route('management.login') }}">Management</a></div>
                              <div class="col-md-4">  <a href="{{ route('employee.login') }}">Employee</a>
                            </div>
                        </div>
