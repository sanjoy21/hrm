                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="{{ route('employee.leave_application_store') }}" method="post" enctype="multipart/form-data" id="leaveForm">
                            @csrf
                            <div class="card-body">
