                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="{{ route('management.leave_application_store') }}" method="post">
                            @csrf
                            <div class="card-body">
                                <input type="hidden" name="employee_id" value="{{ Auth::guard('management')->user()->id }}">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="application" id="compose-textarea" class="form-control" style="height: 300px">
                                        <p>{{ date('jS F, Y') }}</p><p>The Chairman<br>RK Software (Bangladesh) Limited<br>House#286 (2nd floor), Road#19/C<br>New DOHS, Mohakhali, Dhaka-1206</p><p>Subject: Application for leave in advance.</p><p>Dear Sir,</p><p>I beg most respectfully to state that, I am {{ Auth::guard('management')->user()->name }}, an employee of your company, RK Software (Bangladesh) Limited. My designation is {{ Auth::guard('management')->user()->designation }}. I have an occasion in my house on 26/02/2026. That's why I need 1 day leave.</p><p>I, therefore, pray and hope that you will consider my case and approve my leave.</p><p>I remain<br>Sir<br>Your most obedient employee</p><p>{{ Auth::guard('management')->user()->name }}<br>{{ Auth::guard('management')->user()->designation }}<br>Mobile: {{ Auth::guard('management')->user()->mobile }}</p><br>
                                    </textarea>
                                    @error('application')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
