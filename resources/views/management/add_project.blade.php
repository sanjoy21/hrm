                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="{{ route('management.project_add_store') }}" method="post">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" name="project_name" class="form-control" placeholder="Ex: HRM Management">
                                        @error('project_name')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea name="details" id="compose-textarea" class="form-control" style="height: 300px"></textarea>
                                        @error('details')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
